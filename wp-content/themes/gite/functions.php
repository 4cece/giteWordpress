...
function themename_customize_register($wp_customize){
	...
	$wp_customize->add_section( 'footer_options', [
		'title' => __( 'Pied de page et En-tête'),
		'capability' => 'edit_theme_options'
	  ]);

	// Champ logo 
	  
	  $wp_customize->add_setting( 'footer_options_5', [
	  ...
	  $wp_customize->add_control( new WP_Customize_Upload_Control($wp_customize, 'upload_test', [
        ...
        'settings' => 'footer_options_5',
	  ]));
	//   Champs Adresse du site
	 
	  $wp_customize->add_setting( 'footer_options_6', [
		'title' => __( 'Footer column options', 'Universal Theme'),
		'capability' => 'edit_theme_options',
		'description' => __( 'Update footer options')
	  ]);  
	  ...
	  $wp_customize->add_control( 'footer_options_header1', array(
		'settings' => 'footer_options_6',
		'section' => 'footer_options',
		'type' => 'textarea',
		'label' => __( 'Adresse du gite' )
	  ));

	//   Champ téléphone
	  $wp_customize->add_setting( 'footer_options_2', array(
		'title' => __( 'Footer column options', 'Universal Theme'),
		'capability' => 'edit_theme_options',
			'description' => __( 'Update footer options')
	  ));
	...
	//   Champ email
	  $wp_customize->add_setting( 'footer_options_3', array(
		'title' => __( 'Footer column options', 'Universal Theme'),
		'capability' => 'edit_theme_options',
			'description' => __( 'Update footer options')
	  ));
	  ...
	  $wp_customize->add_control( 'footer_options_header3', array(
		'settings' => 'footer_options_3',
		'section' => 'footer_options',
		'type' => 'text',
		'label' => __( 'Email' )
	  ));
	  
	//   Champ Adresse chambre d'hôte
	  $wp_customize->add_setting( 'footer_options_4', array(
		'title' => __( 'Footer column options', 'Universal Theme'),
		'capability' => 'edit_theme_options',
			'description' => __( 'Update footer options')
	  ));
	  ...
	  $wp_customize->add_control( 'footer_options_header4', array(
		'settings' => 'footer_options_4',
		'section' => 'footer_options',
		'type' => 'textarea',
		'label' => __( 'Adresse de la chambre d\'hôte' )
	  ));
...
// Fonction pour mettre en forme le contenue et retirer &nbsp
